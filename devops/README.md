...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trepr-ericof.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for trepr-ericof.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    trepr-ericof.tangrama.com.br:
      ansible_user: root
      host: trepr-ericof
      hostname: trepr-ericof.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trepr-ericof.tangrama.com.br.yml` to the remote server with:
